...
# obis_splist <- read.csv("data/all_splist_20241213.csv")
# 
# # Download and save
...
# gbif_splist <- read.csv("data/all_splist_20241213.csv")
# 
...
# split_dataset("data/raw/gbif_20241213/order=Actiniaria/data_0.parquet",
#               database_name = "gbif",
...
#               batch_size = 100)
# 
# split_dataset("data/raw/gbif_20241213/order=Perciformes/data_0.parquet",
#               database_name = "gbif",
#               grouping_key = "specieskey",
#               sel_keys = gbif_new_keys$new_key,
#               change_key = gbif_new_keys,
